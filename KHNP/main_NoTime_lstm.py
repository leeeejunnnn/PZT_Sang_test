...
from neuralnet_structure import NNv1, CNNv1


#%%
# Define parameters
# Global parameters
train_experiment_num = 1
test_experiment_num = 1
NN = CNNv1
model_name = 'CNN'
train_state = False
...
# Data parameters
DATA_DIR_train = 'G:/Dropbox/1. Lab_KAIST/6. Project/한수원/P_T_data/data_py/notime/train'
DATA_DIR_valid = 'G:/Dropbox/1. Lab_KAIST/6. Project/한수원/P_T_data/data_py/notime/valid'
DATA_DIR_test = 'G:/Dropbox/1. Lab_KAIST/6. Project/한수원/P_T_data/data_py/notime/test'

# NN training parameters
TENSORBOARD_STATE = False
...
dataloader_test = DataLoader(KHNPdata_test, batch_size=BATCH_SIZE, shuffle=True, num_workers=0)
...
optimizer = optim.Adam(neuralnet.parameters(), lr=LEARNING_RATE, weight_decay=L2_DECAY)
